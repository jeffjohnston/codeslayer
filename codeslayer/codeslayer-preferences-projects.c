                                     ...
                                     CodeSlayerProfile     *profile)
{
  ...
  priv->exclude_file_types = codeslayer_preferences_list_view_new (preferences, profile, 
                                       CODESLAYER_REGISTRY_PROJECTS_EXCLUDE_TYPES,
                                       preferences_projects, _("Exclude File Types"));
  
  priv->exclude_directories = codeslayer_preferences_list_view_new (preferences, profile, 
  ...
  g_signal_connect_swapped (G_OBJECT (priv->exclude_file_types), "list-changed",
                            G_CALLBACK (codeslayer_preferences_utils_notify), profile);
