...
#define CODESLAYER_REGISTRY_NOTEBOOK_SEARCH_REGULAR_EXPRESSION "notebook_search_regular_expression"
...
#define CODESLAYER_REGISTRY_REGULAR_EXPRESSION "regular_expression"
