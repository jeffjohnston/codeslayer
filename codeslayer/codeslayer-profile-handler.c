...
/**
 * SECTION:codeslayer-profile_handler
 * @short_description: Contains the projects.
 * @title: CodeSlayerProfileHandler
 * @include: codeslayer/codeslayer-profile_handler.h
 */

static void codeslayer_profile_handler_class_init  (CodeSlayerProfileHandlerClass *klass);
static void codeslayer_profile_handler_init        (CodeSlayerProfileHandler      *profile_handler);
static void codeslayer_profile_handler_finalize    (CodeSlayerProfileHandler      *profile_handler);
...
typedef struct _CodeSlayerProfileHandlerPrivate CodeSlayerProfileHandlerPrivate;

struct _CodeSlayerProfileHandlerPrivate
{
  CodeSlayerProfile *profile;  
};

G_DEFINE_TYPE (CodeSlayerProfileHandler, codeslayer_profile_handler, G_TYPE_OBJECT)
     
static void 
codeslayer_profile_handler_class_init (CodeSlayerProfileHandlerClass *klass)
{
  GObjectClass *gobject_class = G_OBJECT_CLASS (klass);
  
  gobject_class->finalize = (GObjectFinalizeFunc) codeslayer_profile_handler_finalize;

  g_type_class_add_private (klass, sizeof (CodeSlayerProfileHandlerPrivate));                                                      
}

static void
codeslayer_profile_handler_init (CodeSlayerProfileHandler *profile_handler)
{
}

static void
codeslayer_profile_handler_finalize (CodeSlayerProfileHandler *profile_handler)
{
  CodeSlayerProfileHandlerPrivate *priv; 
  priv = CODESLAYER_PROFILE_HANDLER_GET_PRIVATE (profile_handler);  
  g_object_unref (priv->profile);
  G_OBJECT_CLASS (codeslayer_profile_handler_parent_class)->finalize (G_OBJECT (profile_handler));
}

/**
 * codeslayer_profile_handler_new:
 *
 * Creates a new #CodeSlayerProfileHandler.
 *
 * Returns: a new #CodeSlayerProfileHandler. 
 */
CodeSlayerProfileHandler*
codeslayer_profile_handler_new (void)
{
  CodeSlayerProfileHandler *profile_handler;
  profile_handler = CODESLAYER_PROFILE_HANDLER (g_object_new (codeslayer_profile_handler_get_type (), NULL));
  return profile_handler;
}

CodeSlayerProfile*
codeslayer_profile_handler_get_profile (CodeSlayerProfileHandler *profile_handler)
{
  CodeSlayerProfileHandlerPrivate *priv; 
  priv = CODESLAYER_PROFILE_HANDLER_GET_PRIVATE (profile_handler);  
  return priv->profile;
...
CodeSlayerProfile*       
codeslayer_profile_handler_load_new_profile (CodeSlayerProfileHandler *profile_handler, 
                                             GFile                    *file)
{
  CodeSlayerProfileHandlerPrivate *priv;
  gchar *file_path;
...
CodeSlayerProfile*       
codeslayer_profile_handler_load_default_profile (CodeSlayerProfileHandler *profile_handler)
{
  CodeSlayerProfileHandlerPrivate *priv; 
  gchar *file_path;
  GFile *file;
  ...
  if (!g_file_query_exists (file, NULL))
    ...
    {
      priv->profile = codeslayer_profile_handler_load_file_profile (profile_handler, file);
    }    
...
CodeSlayerProfile*
codeslayer_profile_handler_load_file_profile (CodeSlayerProfileHandler *profile_handler, 
                                              GFile                    *file)
{
  CodeSlayerProfileHandlerPrivate *priv;
  xmlDoc *doc = NULL;
...
void
codeslayer_profile_handler_save_profile (CodeSlayerProfileHandler *profile_handler)
{
  CodeSlayerProfileHandlerPrivate *priv; 
  GString *xml;
  gchar *contents;
