...
/**
 * SECTION:codeslayer-engine-projects
...
static void project_renamed_action                 (CodeSlayerProjectsEngine      *engine,
                                                    CodeSlayerProject             *project);
...
static void
project_renamed_action (CodeSlayerProjectsEngine *engine,
                        CodeSlayerProject        *project)
{
  /*CodeSlayerProjectsEnginePrivate *priv;
  CodeSlayerGroup *active_group;
